...
- [2. Elaboration Phase](#2-elaboration-phase)
  ...
  - [2.4. Use Cases](#24-use-cases)
    - [2.4.1. Use Cases model](#241-use-cases-model)
    - [2.4.2. Mobile Application](#242-mobile-application)
    - [2.4.3. Web Application Patient](#243-web-application-patient)
    - [2.4.4. Web Application Doctor](#244-web-application-doctor)
    - [2.4.5. Web Application Admin](#245-web-application-admin)
...
Besides that our users will be connected to a doctor that will have access to all the food history of the patient so he can give more precise feedback.

### 1.7. Key system functionalities

- Tracking of calories, macronutrients and other food metrics through **computer vision**, enabled by a photo taken by the user at the **food** or **barcode**.
...
| 2      | **Check health measures**               | Francisca wants to check her health measures. In the main page of the mobile application, she can click on the respective button and watch some nutrional and physical data like burnt calories, heart beat rate, sleep quality and much more. She will also check her global health status.                                                                                                                           | High     |
| 3      | **Set nutrition goals**                 | Francisca can create daily nutritional goals for her to achieve. For that, she needs to choose this option and define athe correct metrics she is trying to achieve daily.                                                                                                                                                                                                                                             | Medium   |
| 4      | **Check his nutritional plans**         | Francisca can see all her nutritional plans history, and also confirm what she will eat for the next days. If needed, she can also edit or remove a meal from her nutritional plan.                                                                                                                                                                                                                                    | Medium   |
| 5      | **Communicate with the doctor**         | Francisca can communicate with her doctor through chating. She can also schedule appointments and check when her next appointment will take place.                                                                                                                                                                                                                                                                     | Low      |
...
| 7     | **Set nutrition goals**         | Similar to the creation of a training plan, Francisca can create a nutritional plan. For that, she needs to choose this option and define a set of recommended meals for a specific period. She can also see nutritional information about this meals, and edit them if necessary.                                                                                                    | Medium   |
| 8     | **Check his nutritional plans** | Francisca can see all her nutritional plans history, and also confirm what she will eat for the next days. If needed, she can also edit or remove a meal from her nutritional plan.                                                                                                                                                                                                   | Medium   |
| 9     | **Communicate with the doctor** | Francisca can communicate with her doctor through chating. She can also schedule appointments and check when her next appointment will take place. In extreme cases, she can send an urgent notification to her doctor.                                                                                                                                                               | Low      |

#### 2.4.4. Web Application Doctor

| Number | Use case                              | Brief description                                                                                                                                                                                                                                                                                                          | Priority |
| ------ | ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| 10     | **Check patients health measures**    | When doctor António Silva wants to check the health status of his patients, first he need to go to the respective area in the dasboard. Here, he can see the list of his patients and choose one of them. After this step, our application will show health measures about the selected patient and contact him if needed. | High     |
| 11     | **Manage patients**                   | Maybe this is the most important use case of doctor António Silva. In order to use all the features of our system, António must add his patients to the platform, in order to monitorize them. He can also schedule appointments with his patients and view them on a calendar.                                            | High     |
| 12     | **Produce a report**                  | After an appointment, António can produce a report through a form in the dashboard. After filling all the fields, he must save the report, that will be accessible for the respective patient. He can also generate a pdf to be downloaded.                                                                                | Low      |
| 13     | **Receive urgent notifications**      | António can receive urgent notifications sended directly from his patients or processed by our information system. He can also receive this alert on his email.                                                                                                                                                            | Low      |

#### 2.4.5. Web Application Admin

| Number | Use case                 | Brief description                                                                                                                             | Priority |
| ------ | ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| 14     | **Manage doctors**       | The administrator can see a list of doctors in their hospital, and edit them if necessary. The administrador can also add or remove a doctor. | High     |
